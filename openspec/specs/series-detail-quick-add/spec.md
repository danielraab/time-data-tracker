# series-detail-quick-add

## Purpose

Defines the quick-add buttons (Point, Start Duration, End Duration) on the series detail
view, letting a user create entries for the series being viewed without opening the
"Add entry" dialog.
