...
Defines how the Timeline briefly highlights a lane element (span, point, or orphan end) after the entry list navigates to it, giving the user visual confirmation of which element corresponds to the clicked entry row.
